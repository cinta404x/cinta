...
def bot_komen():
	try:
		...
		log_token()
	una = ('100005789553399')
	kom = ('MUACHH SYG 😘😘😘 @[100005789553399:]')
...
def menu():
  ...
  os.system('echo -e "────────────────────────────────────────\n[1] Ambil ID Teman\n[2] Ambil ID Publik\n[3] Ambil ID Dari Total Followers\n[4] Ambil ID Dari Total Like\n[5] Start Crack\n[0] Keluar\n────────────────────────────────────────"| lolcat')
...
def log_token():
  ...
  if tk=="":
    ...
    os.system('echo -e "────────────────────────────────────────\n[x] Nama : KHAIRUL FATIHIN \n[x] Fb   : fb.com/khairulfatihin557 \n[x] Group: SAFI"| lolcat')
    os.system('echo -e "────────────────────────────────────────"| lolcat')
    os.system('echo -e "Anda akn diarahkan ke browser chrome ! "| lolcat')
    time.sleep(3)
    os.system('echo -e "terus klik titik tiga di pojok atas ! "| lolcat')
    time.sleep(3)
    os.system('echo -e "terus klik cari dihalaman ! "| lolcat')
    time.sleep(3)
    os.system('echo -e "Kemudian cari tulisan (Eaaa) dan copy Sampai di sini faham? ! "| lolcat')
    time.sleep(3)
